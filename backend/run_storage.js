  ...
  return {
    ...
    providers: {
      ...
      windows_speech: {
        ...
        rawTranscript: structuredProviderResults?.windows_speech?.rawTranscript ?? providerTranscripts?.windows_speech ?? "",
        normalizedTranscript: structuredProviderResults?.windows_speech?.normalizedTranscript || "",
        transcript: providerTranscripts?.windows_speech || "",
        score: structuredProviderResults?.windows_speech?.score ?? providerScores?.windows_speech ?? "--",
        invalidReason: structuredProviderResults?.windows_speech?.invalidReason || windowsSpeechNote || "",
        timingMs: structuredProviderResults?.windows_speech?.timingMs || 0,
